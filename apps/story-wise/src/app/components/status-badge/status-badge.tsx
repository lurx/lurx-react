		...
		if (health.mode === 'client-only') {
			return (
				...
				>
					<path
						fillRule="evenodd"
						d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.321A1 1 0 0113.315 17H6.685a1 1 0 01-.632-1.74l.804-.321.123-.489H5a2 2 0 01-2-2V5zm2 0h10v8H5V5z"
						clipRule="evenodd"
					/>
				</svg>
			);
