...
export const EMPTY_STATE_ASCII_ART_MAP: Record<
	ExtractObjectValues<typeof EMPTY_STATE_VARIANTS>,
	string
> = {
...
export const EMPTY_STATE_MOBILE_ASCII_ART_MAP: Record<
	ExtractObjectValues<typeof EMPTY_STATE_VARIANTS>,
	string
> = {
...
export const EMPTY_STATE_ASCII_LABELS_MAP: Record<
	ExtractObjectValues<typeof EMPTY_STATE_VARIANTS>,
	string
> = {
