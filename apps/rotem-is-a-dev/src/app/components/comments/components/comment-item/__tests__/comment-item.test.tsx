...
describe('CommentItem', () => {
	it('renders the comment text', () => {
		render(<CommentItem comment={mockComment} isOwn={false} onDeleteAction={mockOnDelete} />);
	...
	it('renders delete button when own comment', () => {
		render(<CommentItem comment={mockComment} isOwn={true} onDeleteAction={mockOnDelete} />);
		expect(screen.getByTestId('comment-delete')).toBeInTheDocument();
	});

	it('calls onDeleteAction with comment id when delete button is clicked', () => {
		render(<CommentItem comment={mockComment} isOwn={true} onDeleteAction={mockOnDelete} />);
	...
	it('renders empty time when createdAt is null', () => {
		...
		render(<CommentItem comment={commentWithoutTimestamp} isOwn={false} onDeleteAction={mockOnDelete} />);
