...
describe('TagFilter', () => {
	it('renders a button for each tag', () => {
		render(<TagFilter tags={TAGS} selected={[]} onToggleAction={jest.fn()} />);
	...
	it('marks selected tags as pressed', () => {
		render(<TagFilter tags={TAGS} selected={['react']} onToggleAction={jest.fn()} />);
	...
	it('calls onToggleAction when a tag is clicked', () => {
		...
		render(<TagFilter tags={TAGS} selected={[]} onToggleAction={onToggle} />);
	...
	it('renders with no tags without errors', () => {
		render(<TagFilter tags={[]} selected={[]} onToggleAction={jest.fn()} />);
