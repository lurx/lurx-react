...
describe('NavItem', () => {
	it('renders the label', () => {
		render(<NavItem label="_hello" href="#hello" active={false} />);
	...
	it('sets aria-current="page" when active', () => {
		render(<NavItem label="_hello" href="#hello" active={true} />);
	...
	it('renders nothing when enabled is false', () => {
		const { container } = render(
			<NavItem label="_about-me" href="#about-me" active={false} enabled={false} />,
		);
		expect(container).toBeEmptyDOMElement();
	});

	it('renders when enabled is true (default)', () => {
		render(<NavItem label="_hello" href="#hello" active={false} enabled={true} />);
		expect(screen.getByText('_hello')).toBeInTheDocument();
	});
});
