  ...
  return (
    <main className={styles.wrapper}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroDescription}>
            I craft beautiful, accessible, and performant web experiences using React, TypeScript, and modern web technologies.
            Currently focused on building scalable design systems and delightful user interfaces.
          </p>
        ...
        <div className={styles.techShowcase}>
          <div className={styles.techGrid}>
            <div className={styles.techCard} data-tech="react">
              <div className={styles.techIcon}>⚛️</div>
              <span>React</span>
            </div>
            <div className={styles.techCard} data-tech="typescript">
              <div className={styles.techIcon}>�</div>
              <span>TypeScript</span>
            </div>
            <div className={styles.techCard} data-tech="nextjs">
              <div className={styles.techIcon}>▲</div>
              <span>Next.js</span>
            </div>
            <div className={styles.techCard} data-tech="sass">
              <div className={styles.techIcon}>🎨</div>
              <span>SCSS</span>
            </div>
            <div className={styles.techCard} data-tech="testing">
              <div className={styles.techIcon}>🧪</div>
              <span>Testing</span>
            </div>
            <div className={styles.techCard} data-tech="a11y">
              <div className={styles.techIcon}>♿</div>
      ...
      <section className={styles.quickLinks}>
        <a href="https://github.com/lurx" target="_blank" rel="noopener noreferrer" className={styles.quickLink}>
        ...
        <a href="mailto:rotem@example.com" className={styles.quickLink}>
          <div className={styles.linkIcon}>
          ...
          <div className={styles.linkContent}>
            ...
            <span className={styles.linkDescription}>Let&apos;s work together</span>
          </div>
        </a>

        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className={styles.quickLink}>
          <div className={styles.linkIcon}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
