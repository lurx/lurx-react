        ...
        tools: [
          {
            ...
            description: 'List all available Vanguardis components with their descriptions and types',
            inputSchema: {
              type: 'object',
              properties: {
                category: {
                  type: 'string',
                  description: 'Optional category filter (animation, layout, ui, provider)',
          ...
          },
          {
            ...
            description: 'Get detailed information about a specific Vanguardis component including props, usage examples, and TypeScript definitions',
            inputSchema: {
              type: 'object',
              properties: {
                componentName: {
          ...
          },
          {
            ...
            description: 'Get design tokens from the Vanguardis design system (colors, spacing, typography, etc.)',
            inputSchema: {
              type: 'object',
              properties: {
                category: {
                  ...
                  enum: ['colors', 'spacing', 'typography', 'shadows', 'borderRadius', 'animations', 'all'],
                  default: 'all',
                },
              },
            },
          },
          {
            ...
            description: 'Generate a complete usage example for a Vanguardis component with customizable props',
            inputSchema: {
              type: 'object',
              properties: {
                componentName: {
                ...
                includeImports: {
                  type: 'boolean',
                  description: 'Whether to include import statements (default: true)',
                  default: true,
                },
                wrapWithProvider: {
                  type: 'boolean',
                  description: 'Whether to wrap example with VanguardisProvider (default: true)',
                  default: true,
                },
              },
              required: ['componentName'],
          ...
          },
          {
            ...
            description: 'List and get documentation for Vanguardis custom React hooks',
            inputSchema: {
              type: 'object',
              properties: {
                hookName: {
                  type: 'string',
                  description: 'Specific hook name to get documentation for (optional)',
                },
              },
            },
          },
          {
            ...
            description: 'List and get documentation for Vanguardis utility functions',
            inputSchema: {
              type: 'object',
              properties: {
                utilName: {
                  type: 'string',
                  description: 'Specific utility function name to get documentation for (optional)',
                },
              },
            },
          },
          {
            ...
            description: 'Search through Vanguardis components, hooks, and utilities by name or functionality',
            inputSchema: {
              type: 'object',
              properties: {
                query: {
                  type: 'string',
                  description: 'Search query (component name, functionality, or keyword)',
                },
                type: {
                  type: 'string',
